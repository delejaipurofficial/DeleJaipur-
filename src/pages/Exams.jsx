                ...
                <div className="flex gap-2">
                  ...
                  <p className="leading-relaxed">
                    ...
                    <span className="block mt-1">
                      Written exams begin at 9:00 a.m., but the presence of the candidate is required at the exam center at 08:30 h. to verify your documentation and to receive precise instructions.
                    </span>
                  </p>
                </div>
                <div className="flex gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-primary-container flex-shrink-0 mt-2" />
                  <p className="leading-relaxed">
                    <strong className="text-onSurface font-bold">Oral Exams:</strong> The oral exams vary according to the number of candidates and test may be scheduled up to 2 days before or 2 days after the official written exam date.
                  </p>
                </div>
